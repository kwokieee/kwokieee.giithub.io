  ...
  return (
    <div className="flex flex-col justify-center items-start py-4 px-8">
      <div className="flex items-center w-full mb-4 px-8 sm:px-16">
        ...
        <h1 className="text-lg sm:text-4xl font-extrabold px-2">NUS Rover Team</h1>
        <span className="bg-[#393434] h-1 w-4 rounded-sm grow" />
      </div>
      ...
      <div className="py-4">
        <span className="flex">
          ...
          <p className="text-xs sm:text-base">Project Manager</p>
        </span>
        <span className="flex">
          <span className="mr-2 flex items-center">
            <Icon icon="uil:calender" />
          </span>
          <p className="text-xs sm:text-base">Sep 2020 - Apr 2022 (1.5 yrs)</p>
        </span>
      </div>
