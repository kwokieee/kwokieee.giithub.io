...
function Hero() {
  return (
    <Section noPadding sectionId={SectionId.Hero}>
      <div className="sm:h-screen lg:h-auto flex flex-col lg:flex-row">
        <div className="lg:max-w-[1000px]">
          <img src="/images/hero-photo.png" className="object-cover" />
        </div>
        <div className="bg-[#393434] p-6 flex flex-col justify-center items-center sm:h-full lg:h-auto sm:min-w-[500px] w-full">
